defmodule Time1.SheetsTest do
  ...
  describe "sheets" do
    ...
    @valid_attrs %{approve_status: true, date: ~D[2010-04-17]}
    @update_attrs %{approve_status: false, date: ~D[2011-05-18]}
    @invalid_attrs %{approve_status: nil, date: nil}
    ...
    test "create_sheet/1 with valid data creates a sheet" do
      ...
      assert sheet.approve_status == true
    ...
    test "update_sheet/2 with valid data updates the sheet" do
      ...
      assert sheet.approve_status == false
